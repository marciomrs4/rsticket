...
<form name="cadastrar/AssentamentoSolicitante" id="AssentamentoSolicitante" enctype="multipart/form-data" method="post" action="../<?php echo($_SESSION['projeto']); ?>/action/assentamento.php">
<fieldset>
